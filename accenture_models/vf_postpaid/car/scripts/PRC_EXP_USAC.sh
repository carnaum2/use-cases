...
hive -hiveconf hive.log4j.file=$HOME/hive-log4j_${log_file}.properties -hiveconf MONTH0=$M0 -hiveconf MONTH1=$M1 -i $ruta_ql/PRC_EXP_USAC.hql #>> $ruta_log/PRC_EXP_USAC.log
