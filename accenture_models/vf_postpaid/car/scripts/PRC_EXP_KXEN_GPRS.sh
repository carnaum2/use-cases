...
if [ $# -ne $num_arguments ]; then
	...
	echo '1. Pair YearMonth without spaces'
        ...
        echo ">>>>>>>ERROR<<<<<<< Example: ./PRC_EXP_KXEN_GPRS.sh 201610 "
        echo -e "\n"
        exit -1
...
hive -hiveconf hive.log4j.file=$HOME/hive-log4j_${log_file}.properties -hiveconf MONTH0=$1 -hiveconf MONTH1=$arg2 -hiveconf MONTH2=$arg3 -hiveconf MONTH3=$arg4 -i $ruta_ql/PRC_EXP_KXEN_GPRS.hql #>> $ruta_log/PRC_EXP_KXEN_GPRS.log
