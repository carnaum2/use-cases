...
--CREATE WORK_LLAMADAS_SAL_EMP

set mapred.job.name=WORK_LLAMADAS_SAL_EMP;
DROP TABLE IF EXISTS WORK.WORK_LLAMADAS_SAL_EMP;    
CREATE TABLE WORK.WORK_LLAMADAS_SAL_EMP AS
SELECT
DAVO_SAL_E.MSISDN,
DAVO_SAL_E.ID_OPERADOR,
DAVO_SAL_E.DS_OPERADOR,
DAVO_SAL_E.TIPO_LLAMADA,
DAVO_SAL_E.NUM_DIST_LLAM,
DAVO_SAL_E.NUM_TOT_LLAM,
DAVO_SAL_E.DURACION,
DAVO_SAL_E.MES,   
(CASE    
WHEN   ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1, 8))) = 'MOVISTAR') OR ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1, 8))) = 'MOVILINE') OR ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1,5))) = 'TELEF')
THEN 'MOVISTAR' 

WHEN   ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1, 8))) = 'VODAFONE') OR ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1, 5))) = 'TELE2') OR ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1,6))) = 'AIRTEL')
THEN 'VODAFONE'

WHEN   ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1, 5))) = 'AMENA') OR ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1, 5))) = 'UNI2')
THEN 'ORANGE'       

WHEN   ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1, 5))) = 'XFERA') OR ((UPPER(SUBSTR(DAVO_SAL_E.DS_OPERADOR, 1, 5))) = 'YOIGO')
THEN 'YOIGO'

ELSE
'OTROS'
END) AS CAT_OPERADOR                                                                                                
FROM (SELECT MSISDN,  ID_OPERADOR, DS_OPERADOR, TIPO_LLAMADA, CAST(NUM_DIST_LLAM AS DOUBLE) AS NUM_DIST_LLAM, CAST(NUM_TOT_LLAM AS DOUBLE) AS NUM_TOT_LLAM, CAST(DURACION AS DOUBLE) AS DURACION, PARTITIONED_MONTH AS  MES
FROM  INPUT.VF_EBU_DAVO_SAL_E) DAVO_SAL_E;

--CREATE WORK_LLAMADAS_ENTR_EMP_M0

set mapred.job.name=WORK_LLAMADAS_ENTR_EMP_M0;
DROP TABLE IF EXISTS WORK.WORK_LLAMADAS_ENTR_EMP_M0;    
CREATE TABLE WORK.WORK_LLAMADAS_ENTR_EMP_M0 AS
SELECT            
	  B.MSISDN,
	  B.MES,     
	  B.ID_OPERADOR,
  ...
  FROM (SELECT * 
  FROM INPUT.VF_POS_AC_FINAL
  WHERE PARTITIONED_MONTH =  '${hiveconf:MONTH0}') A
  RIGHT JOIN
  (SELECT MSISDN,  PARTITIONED_MONTH AS MES, ID_OPERADOR, TIPO_LLAMADA, CAST(NUM_DIST_LLAM AS DOUBLE) AS NUM_DIST_LLAM, CAST(NUM_TOT_LLAM AS DOUBLE) AS NUM_TOT_LLAM,  CAST(DURACION AS DOUBLE) AS DURACION
	FROM INPUT.VF_POS_DAVO_ENTR_C
	WHERE PARTITIONED_MONTH =  '${hiveconf:MONTH0}') B
  ON A.X_ID_RED = B.MSISDN
  WHERE A.X_ID_RED IS NULL;
  
--CREATE WORK_LLAMADAS_ENTR_EMP_M1

set mapred.job.name=WORK_LLAMADAS_ENTR_EMP_M1;
DROP TABLE IF EXISTS WORK.WORK_LLAMADAS_ENTR_EMP_M1;    
CREATE TABLE WORK.WORK_LLAMADAS_ENTR_EMP_M1 AS
SELECT            
	  B.MSISDN,
	  B.MES,     
	  B.ID_OPERADOR,
  ...
  FROM (SELECT * 
  FROM INPUT.VF_POS_AC_FINAL
  WHERE PARTITIONED_MONTH =  '${hiveconf:MONTH1}') A
  RIGHT JOIN
  (SELECT MSISDN,  PARTITIONED_MONTH AS MES, ID_OPERADOR, TIPO_LLAMADA, CAST(NUM_DIST_LLAM AS DOUBLE) AS NUM_DIST_LLAM, CAST(NUM_TOT_LLAM AS DOUBLE) AS NUM_TOT_LLAM,  CAST(DURACION AS DOUBLE) AS DURACION
	FROM INPUT.VF_POS_DAVO_ENTR_C
	WHERE PARTITIONED_MONTH =  '${hiveconf:MONTH1}') B
  ON A.X_ID_RED = B.MSISDN
  WHERE A.X_ID_RED IS NULL;

--CREATE WORK_LLAMADAS_ENTR_EMP_M2

set mapred.job.name=WORK_LLAMADAS_ENTR_EMP_M2;
DROP TABLE IF EXISTS WORK.WORK_LLAMADAS_ENTR_EMP_M2;    
CREATE TABLE WORK.WORK_LLAMADAS_ENTR_EMP_M2 AS
SELECT            
	  B.MSISDN,
	  B.MES,     
	  B.ID_OPERADOR,
  ...
  FROM (SELECT * 
  FROM INPUT.VF_POS_AC_FINAL
  WHERE PARTITIONED_MONTH =  '${hiveconf:MONTH2}') A
  RIGHT JOIN
  (SELECT MSISDN,  PARTITIONED_MONTH AS MES, ID_OPERADOR, TIPO_LLAMADA, CAST(NUM_DIST_LLAM AS DOUBLE) AS NUM_DIST_LLAM, CAST(NUM_TOT_LLAM AS DOUBLE) AS NUM_TOT_LLAM,  CAST(DURACION AS DOUBLE) AS DURACION
	FROM INPUT.VF_POS_DAVO_ENTR_C
	WHERE PARTITIONED_MONTH =  '${hiveconf:MONTH2}') B
  ON A.X_ID_RED = B.MSISDN
  WHERE A.X_ID_RED IS NULL;

--CREATE WORK_LLAMADAS_ENTR_EMP_M3

set mapred.job.name=WORK_LLAMADAS_ENTR_EMP_M3;
DROP TABLE IF EXISTS WORK.WORK_LLAMADAS_ENTR_EMP_M3;    
CREATE TABLE WORK.WORK_LLAMADAS_ENTR_EMP_M3 AS
SELECT            
	  B.MSISDN,
	  B.MES,     
	  B.ID_OPERADOR,
  ...
  FROM (SELECT * 
  FROM INPUT.VF_POS_AC_FINAL
  WHERE PARTITIONED_MONTH =  '${hiveconf:MONTH3}') A
  RIGHT JOIN
  (SELECT MSISDN,  PARTITIONED_MONTH AS MES, ID_OPERADOR, TIPO_LLAMADA, CAST(NUM_DIST_LLAM AS DOUBLE) AS NUM_DIST_LLAM, CAST(NUM_TOT_LLAM AS DOUBLE) AS NUM_TOT_LLAM,  CAST(DURACION AS DOUBLE) AS DURACION
	FROM INPUT.VF_POS_DAVO_ENTR_C
	WHERE PARTITIONED_MONTH =  '${hiveconf:MONTH3}') B
  ON A.X_ID_RED = B.MSISDN
  WHERE A.X_ID_RED IS NULL;		
...
-- MES0   
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_MV_M0;
CREATE TABLE WORK.WORK_ENTORNO_SAL_MV_M0 AS
SELECT
SAL_EMP_M0.MSISDN,
SUM(SAL_EMP_M0.DURACION) / 60 AS NUM_SAL_MIN_MV,
SUM(SAL_EMP_M0.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_MV,
SUM(SAL_EMP_M0.NUM_TOT_LLAM) AS NUM_SAL_LLAM_MV
FROM
(SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH0}') SAL_EMP_M0
WHERE SAL_EMP_M0.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M0.CAT_OPERADOR LIKE '%MOVISTAR%'
GROUP BY SAL_EMP_M0.MSISDN;
        
set mapred.job.name=WORK_ENTORNO_SAL_VF_M0;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_VF_M0;
CREATE TABLE WORK.WORK_ENTORNO_SAL_VF_M0 AS
SELECT
SAL_EMP_M0.MSISDN,
SUM(SAL_EMP_M0.DURACION) / 60 AS NUM_SAL_MIN_VF,
SUM(SAL_EMP_M0.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_VF,
SUM(SAL_EMP_M0.NUM_TOT_LLAM) AS NUM_SAL_LLAM_VF
FROM
(SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH0}') SAL_EMP_M0
WHERE SAL_EMP_M0.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M0.CAT_OPERADOR LIKE '%VODAFONE%'
GROUP BY SAL_EMP_M0.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_OG_M0;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_OG_M0;
CREATE TABLE WORK.WORK_ENTORNO_SAL_OG_M0 AS
SELECT
SAL_EMP_M0.MSISDN,
SUM(SAL_EMP_M0.DURACION) / 60 AS NUM_SAL_MIN_OG,
SUM(SAL_EMP_M0.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_OG,
SUM(SAL_EMP_M0.NUM_TOT_LLAM) AS NUM_SAL_LLAM_OG
FROM
(SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH0}') SAL_EMP_M0
WHERE SAL_EMP_M0.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M0.CAT_OPERADOR LIKE '%ORANGE%'
GROUP BY SAL_EMP_M0.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_YO_M0;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_YO_M0;
CREATE TABLE WORK.WORK_ENTORNO_SAL_YO_M0 AS
SELECT
SAL_EMP_M0.MSISDN,
SUM(SAL_EMP_M0.DURACION) / 60 AS NUM_SAL_MIN_YO,
SUM(SAL_EMP_M0.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_YO,
SUM(SAL_EMP_M0.NUM_TOT_LLAM) AS NUM_SAL_LLAM_YO
FROM
(SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH0}') SAL_EMP_M0
WHERE SAL_EMP_M0.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M0.CAT_OPERADOR LIKE '%YOIGO%'
GROUP BY SAL_EMP_M0.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_RE_M0;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_RE_M0;
CREATE TABLE WORK.WORK_ENTORNO_SAL_RE_M0 AS
SELECT
SAL_EMP_M0.MSISDN,
SUM(SAL_EMP_M0.DURACION) / 60 AS NUM_SAL_MIN_RE,
SUM(SAL_EMP_M0.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_RE,
SUM(SAL_EMP_M0.NUM_TOT_LLAM) AS NUM_SAL_LLAM_RE
FROM
(SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH0}') SAL_EMP_M0
WHERE SAL_EMP_M0.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M0.CAT_OPERADOR LIKE '%OTROS%'
GROUP BY SAL_EMP_M0.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_TOT_M0;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_TOT_M0;
CREATE TABLE WORK.WORK_ENTORNO_SAL_TOT_M0 AS
SELECT
SAL_EMP_M0.MSISDN,
SUM(SAL_EMP_M0.DURACION) / 60 AS NUM_SAL_MIN_TOT,
SUM(SAL_EMP_M0.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_TOT,
SUM(SAL_EMP_M0.NUM_TOT_LLAM) AS NUM_SAL_LLAM_TOT
FROM
(SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH0}') SAL_EMP_M0
WHERE SAL_EMP_M0.TIPO_LLAMADA = 'VOZ'
GROUP BY SAL_EMP_M0.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_SMS_TOT_M0;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_SMS_TOT_M0;
CREATE TABLE WORK.WORK_ENTORNO_SAL_SMS_TOT_M0 AS
SELECT
SAL_EMP_M0.MSISDN,
SUM(SAL_EMP_M0.NUM_DIST_LLAM) AS NUM_SAL_SMS_DIST_TOT,
SUM(SAL_EMP_M0.NUM_TOT_LLAM) AS NUM_SAL_SMS_TOT
FROM
(SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH0}') SAL_EMP_M0
WHERE SAL_EMP_M0.TIPO_LLAMADA = 'SMS'
GROUP BY SAL_EMP_M0.MSISDN;
    
        
set mapred.job.name=WORK_ENTORNO_SAL_MV_M1;
-- MES1
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_MV_M1;
CREATE TABLE WORK.WORK_ENTORNO_SAL_MV_M1 AS
          SELECT
            SAL_EMP_M1.MSISDN,
            SUM(SAL_EMP_M1.DURACION) / 60 AS NUM_SAL_MIN_MV,
            SUM(SAL_EMP_M1.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_MV,
            SUM(SAL_EMP_M1.NUM_TOT_LLAM) AS NUM_SAL_LLAM_MV
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH1}') SAL_EMP_M1
          WHERE SAL_EMP_M1.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M1.CAT_OPERADOR LIKE '%MOVISTAR%'
          GROUP BY SAL_EMP_M1.MSISDN;
        
set mapred.job.name=WORK_ENTORNO_SAL_VF_M1;

DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_VF_M1;

CREATE TABLE WORK.WORK_ENTORNO_SAL_VF_M1 AS
          SELECT
            SAL_EMP_M1.MSISDN,
            SUM(SAL_EMP_M1.DURACION) / 60 AS NUM_SAL_MIN_VF,
            SUM(SAL_EMP_M1.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_VF,
            SUM(SAL_EMP_M1.NUM_TOT_LLAM) AS NUM_SAL_LLAM_VF
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH1}') SAL_EMP_M1
          WHERE SAL_EMP_M1.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M1.CAT_OPERADOR LIKE '%VODAFONE%'
          GROUP BY SAL_EMP_M1.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_OG_M1;

DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_OG_M1;

CREATE TABLE WORK.WORK_ENTORNO_SAL_OG_M1 AS
          SELECT
            SAL_EMP_M1.MSISDN,
            SUM(SAL_EMP_M1.DURACION) / 60 AS NUM_SAL_MIN_OG,
            SUM(SAL_EMP_M1.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_OG,
            SUM(SAL_EMP_M1.NUM_TOT_LLAM) AS NUM_SAL_LLAM_OG
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH1}') SAL_EMP_M1
          WHERE SAL_EMP_M1.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M1.CAT_OPERADOR LIKE '%ORANGE%'
          GROUP BY SAL_EMP_M1.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_YO_M1;

DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_YO_M1;

CREATE TABLE WORK.WORK_ENTORNO_SAL_YO_M1 AS
          SELECT
            SAL_EMP_M1.MSISDN,
            SUM(SAL_EMP_M1.DURACION) / 60 AS NUM_SAL_MIN_YO,
            SUM(SAL_EMP_M1.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_YO,
            SUM(SAL_EMP_M1.NUM_TOT_LLAM) AS NUM_SAL_LLAM_YO
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH1}') SAL_EMP_M1
          WHERE SAL_EMP_M1.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M1.CAT_OPERADOR LIKE '%YOIGO%'
          GROUP BY SAL_EMP_M1.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_RE_M1;

DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_RE_M1;

CREATE TABLE WORK.WORK_ENTORNO_SAL_RE_M1 AS
          SELECT
            SAL_EMP_M1.MSISDN,
            SUM(SAL_EMP_M1.DURACION) / 60 AS NUM_SAL_MIN_RE,
            SUM(SAL_EMP_M1.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_RE,
            SUM(SAL_EMP_M1.NUM_TOT_LLAM) AS NUM_SAL_LLAM_RE
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH1}') SAL_EMP_M1
          WHERE SAL_EMP_M1.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M1.CAT_OPERADOR LIKE '%OTROS%'
          GROUP BY SAL_EMP_M1.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_TOT_M1;

DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_TOT_M1;

CREATE TABLE WORK.WORK_ENTORNO_SAL_TOT_M1 AS
          SELECT
            SAL_EMP_M1.MSISDN,
            SUM(SAL_EMP_M1.DURACION) / 60 AS NUM_SAL_MIN_TOT,
            SUM(SAL_EMP_M1.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_TOT,
            SUM(SAL_EMP_M1.NUM_TOT_LLAM) AS NUM_SAL_LLAM_TOT
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH1}') SAL_EMP_M1
          WHERE SAL_EMP_M1.TIPO_LLAMADA = 'VOZ'
          GROUP BY SAL_EMP_M1.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_SMS_TOT_M1;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_SMS_TOT_M1;
CREATE TABLE WORK.WORK_ENTORNO_SAL_SMS_TOT_M1 AS
          SELECT
            SAL_EMP_M1.MSISDN,
            SUM(SAL_EMP_M1.NUM_DIST_LLAM) AS NUM_SAL_SMS_DIST_TOT,
            SUM(SAL_EMP_M1.NUM_TOT_LLAM) AS NUM_SAL_SMS_TOT
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH1}') SAL_EMP_M1
          WHERE SAL_EMP_M1.TIPO_LLAMADA = 'SMS'
          GROUP BY SAL_EMP_M1.MSISDN;
  
        
set mapred.job.name=WORK_ENTORNO_SAL_MV_M2;
-- MES 2
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_MV_M2;
CREATE TABLE WORK.WORK_ENTORNO_SAL_MV_M2 AS
          SELECT
            SAL_EMP_M2.MSISDN,
            SUM(SAL_EMP_M2.DURACION) / 60 AS NUM_SAL_MIN_MV,
            SUM(SAL_EMP_M2.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_MV,
            SUM(SAL_EMP_M2.NUM_TOT_LLAM) AS NUM_SAL_LLAM_MV
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH2}') SAL_EMP_M2
          WHERE SAL_EMP_M2.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M2.CAT_OPERADOR LIKE '%MOVISTAR%'
          GROUP BY SAL_EMP_M2.MSISDN;
        
set mapred.job.name=WORK_ENTORNO_SAL_VF_M2;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_VF_M2;
CREATE TABLE WORK.WORK_ENTORNO_SAL_VF_M2 AS
          SELECT
            SAL_EMP_M2.MSISDN,
            SUM(SAL_EMP_M2.DURACION) / 60 AS NUM_SAL_MIN_VF,
            SUM(SAL_EMP_M2.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_VF,
            SUM(SAL_EMP_M2.NUM_TOT_LLAM) AS NUM_SAL_LLAM_VF
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH2}') SAL_EMP_M2
          WHERE SAL_EMP_M2.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M2.CAT_OPERADOR LIKE '%VODAFONE%'
          GROUP BY SAL_EMP_M2.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_OG_M2;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_OG_M2;
CREATE TABLE WORK.WORK_ENTORNO_SAL_OG_M2 AS
          SELECT
            SAL_EMP_M2.MSISDN,
            SUM(SAL_EMP_M2.DURACION) / 60 AS NUM_SAL_MIN_OG,
            SUM(SAL_EMP_M2.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_OG,
            SUM(SAL_EMP_M2.NUM_TOT_LLAM) AS NUM_SAL_LLAM_OG
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH2}') SAL_EMP_M2
          WHERE SAL_EMP_M2.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M2.CAT_OPERADOR LIKE '%ORANGE%'
          GROUP BY SAL_EMP_M2.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_YO_M2;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_YO_M2;
CREATE TABLE WORK.WORK_ENTORNO_SAL_YO_M2 AS
          SELECT
            SAL_EMP_M2.MSISDN,
            SUM(SAL_EMP_M2.DURACION) / 60 AS NUM_SAL_MIN_YO,
            SUM(SAL_EMP_M2.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_YO,
            SUM(SAL_EMP_M2.NUM_TOT_LLAM) AS NUM_SAL_LLAM_YO
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH2}') SAL_EMP_M2
          WHERE SAL_EMP_M2.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M2.CAT_OPERADOR LIKE '%YOIGO%'
          GROUP BY SAL_EMP_M2.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_RE_M2;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_RE_M2;
CREATE TABLE WORK.WORK_ENTORNO_SAL_RE_M2 AS
          SELECT
            SAL_EMP_M2.MSISDN,
            SUM(SAL_EMP_M2.DURACION) / 60 AS NUM_SAL_MIN_RE,
            SUM(SAL_EMP_M2.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_RE,
            SUM(SAL_EMP_M2.NUM_TOT_LLAM) AS NUM_SAL_LLAM_RE
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH2}') SAL_EMP_M2
          WHERE SAL_EMP_M2.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M2.CAT_OPERADOR LIKE '%OTROS%'
          GROUP BY SAL_EMP_M2.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_TOT_M2;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_TOT_M2;
CREATE TABLE WORK.WORK_ENTORNO_SAL_TOT_M2 AS
          SELECT
            SAL_EMP_M2.MSISDN,
            SUM(SAL_EMP_M2.DURACION) / 60 AS NUM_SAL_MIN_TOT,
            SUM(SAL_EMP_M2.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_TOT,
            SUM(SAL_EMP_M2.NUM_TOT_LLAM) AS NUM_SAL_LLAM_TOT
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH2}') SAL_EMP_M2
          WHERE SAL_EMP_M2.TIPO_LLAMADA = 'VOZ'
          GROUP BY SAL_EMP_M2.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_SMS_TOT_M2;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_SMS_TOT_M2;
CREATE TABLE WORK.WORK_ENTORNO_SAL_SMS_TOT_M2 AS
          SELECT
            SAL_EMP_M2.MSISDN,
            SUM(SAL_EMP_M2.NUM_DIST_LLAM) AS NUM_SAL_SMS_DIST_TOT,
            SUM(SAL_EMP_M2.NUM_TOT_LLAM) AS NUM_SAL_SMS_TOT
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH2}') SAL_EMP_M2
          WHERE SAL_EMP_M2.TIPO_LLAMADA = 'SMS'
          GROUP BY SAL_EMP_M2.MSISDN;
        
       
set mapred.job.name=WORK_ENTORNO_SAL_MV_M3;
-- MES 3 CREATE TABLE VF_SAMAIN.UNE_PROPENSOS_AUT_SO_   
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_MV_M3;
CREATE TABLE WORK.WORK_ENTORNO_SAL_MV_M3 AS
          SELECT
            SAL_EMP_M3.MSISDN,
            SUM(SAL_EMP_M3.DURACION) / 60 AS NUM_SAL_MIN_MV,
            SUM(SAL_EMP_M3.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_MV,
            SUM(SAL_EMP_M3.NUM_TOT_LLAM) AS NUM_SAL_LLAM_MV
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH3}') SAL_EMP_M3
          WHERE SAL_EMP_M3.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M3.CAT_OPERADOR LIKE '%MOVISTAR%'
          GROUP BY SAL_EMP_M3.MSISDN;
        
set mapred.job.name=WORK_ENTORNO_SAL_VF_M3;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_VF_M3;
CREATE TABLE WORK.WORK_ENTORNO_SAL_VF_M3 AS
          SELECT
            SAL_EMP_M3.MSISDN,
            SUM(SAL_EMP_M3.DURACION) / 60 AS NUM_SAL_MIN_VF,
            SUM(SAL_EMP_M3.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_VF,
            SUM(SAL_EMP_M3.NUM_TOT_LLAM) AS NUM_SAL_LLAM_VF
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH3}') SAL_EMP_M3
          WHERE SAL_EMP_M3.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M3.CAT_OPERADOR LIKE '%VODAFONE%'
          GROUP BY SAL_EMP_M3.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_OG_M3;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_OG_M3;
CREATE TABLE WORK.WORK_ENTORNO_SAL_OG_M3 AS
          SELECT
            SAL_EMP_M3.MSISDN,
            SUM(SAL_EMP_M3.DURACION) / 60 AS NUM_SAL_MIN_OG,
            SUM(SAL_EMP_M3.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_OG,
            SUM(SAL_EMP_M3.NUM_TOT_LLAM) AS NUM_SAL_LLAM_OG
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH3}') SAL_EMP_M3
          WHERE SAL_EMP_M3.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M3.CAT_OPERADOR LIKE '%ORANGE%'
          GROUP BY SAL_EMP_M3.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_YO_M3;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_YO_M3;
CREATE TABLE WORK.WORK_ENTORNO_SAL_YO_M3 AS
          SELECT
            SAL_EMP_M3.MSISDN,
            SUM(SAL_EMP_M3.DURACION) / 60 AS NUM_SAL_MIN_YO,
            SUM(SAL_EMP_M3.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_YO,
            SUM(SAL_EMP_M3.NUM_TOT_LLAM) AS NUM_SAL_LLAM_YO
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH3}') SAL_EMP_M3
          WHERE SAL_EMP_M3.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M3.CAT_OPERADOR LIKE '%YOIGO%'
          GROUP BY SAL_EMP_M3.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_RE_M3;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_RE_M3;
CREATE TABLE WORK.WORK_ENTORNO_SAL_RE_M3 AS
          SELECT
            SAL_EMP_M3.MSISDN,
            SUM(SAL_EMP_M3.DURACION) / 60 AS NUM_SAL_MIN_RE,
            SUM(SAL_EMP_M3.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_RE,
            SUM(SAL_EMP_M3.NUM_TOT_LLAM) AS NUM_SAL_LLAM_RE
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH3}') SAL_EMP_M3
          WHERE SAL_EMP_M3.TIPO_LLAMADA = 'VOZ' AND SAL_EMP_M3.CAT_OPERADOR LIKE '%OTROS%'
          GROUP BY SAL_EMP_M3.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_TOT_M3;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_TOT_M3;
CREATE TABLE WORK.WORK_ENTORNO_SAL_TOT_M3 AS
          SELECT
            SAL_EMP_M3.MSISDN,
            SUM(SAL_EMP_M3.DURACION) / 60 AS NUM_SAL_MIN_TOT,
            SUM(SAL_EMP_M3.NUM_DIST_LLAM) AS NUM_SAL_LLAM_DIST_TOT,
            SUM(SAL_EMP_M3.NUM_TOT_LLAM) AS NUM_SAL_LLAM_TOT
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH3}') SAL_EMP_M3
          WHERE SAL_EMP_M3.TIPO_LLAMADA = 'VOZ'
          GROUP BY SAL_EMP_M3.MSISDN;
          
set mapred.job.name=WORK_ENTORNO_SAL_SMS_TOT_M3;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_SMS_TOT_M3;
CREATE TABLE WORK.WORK_ENTORNO_SAL_SMS_TOT_M3 AS
          SELECT
            SAL_EMP_M3.MSISDN,
            SUM(SAL_EMP_M3.NUM_DIST_LLAM) AS NUM_SAL_SMS_DIST_TOT,
            SUM(SAL_EMP_M3.NUM_TOT_LLAM) AS NUM_SAL_SMS_TOT
          FROM
            (SELECT * FROM WORK.WORK_LLAMADAS_SAL_EMP WHERE MES = '${hiveconf:MONTH3}') SAL_EMP_M3
          WHERE SAL_EMP_M3.TIPO_LLAMADA = 'SMS'
          GROUP BY SAL_EMP_M3.MSISDN;


set mapred.job.name=WORK_ENTORNO_SAL_TOT;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_SAL_TOT;
CREATE TABLE WORK.WORK_ENTORNO_SAL_TOT AS
        ...
        FROM
          ...
          (SELECT DISTINCT MSISDN, CIF_NIF  FROM INPUT.VF_EBU_AC_EMP_CARTERA_SERVICIO  WHERE PARTITIONED_MONTH =  '${hiveconf:MONTH0}') M
          LEFT JOIN
...
-- ENTRANTE
        ...
        -- MES0 
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_ENT_TOT_M0;
CREATE TABLE WORK.WORK_ENTORNO_ENT_TOT_M0 AS
          ...
          FROM
             WORK.WORK_LLAMADAS_ENTR_EMP_M0
          WHERE TIPO_LLAMADA = 'VOZ'
          GROUP BY MSISDN;
          
set mapred.job.name=WORK_ENTORNO_ENT_SMS_TOT_M0;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_ENT_SMS_TOT_M0;
...
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_ENT_TOT_M1;
CREATE TABLE WORK.WORK_ENTORNO_ENT_TOT_M1 AS
          SELECT
            ...
            SUM(NUM_TOT_LLAM) AS NUM_ENT_LLAM_TOT
          FROM
             WORK.WORK_LLAMADAS_ENTR_EMP_M1
          WHERE TIPO_LLAMADA = 'VOZ'
          GROUP BY MSISDN;
          
set mapred.job.name=WORK_ENTORNO_ENT_SMS_TOT_M1;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_ENT_SMS_TOT_M1;
...
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_ENT_TOT_M2;
CREATE TABLE WORK.WORK_ENTORNO_ENT_TOT_M2 AS
          SELECT
            ...
            SUM(NUM_TOT_LLAM) AS NUM_ENT_LLAM_TOT
          FROM
             WORK.WORK_LLAMADAS_ENTR_EMP_M2
          WHERE TIPO_LLAMADA = 'VOZ'
          GROUP BY MSISDN;
          
set mapred.job.name=WORK_ENTORNO_ENT_SMS_TOT_M2;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_ENT_SMS_TOT_M2;
...
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_ENT_TOT_M3;
CREATE TABLE WORK.WORK_ENTORNO_ENT_TOT_M3 AS
          SELECT
            ...
            SUM(NUM_TOT_LLAM) AS NUM_ENT_LLAM_TOT
          FROM
             WORK.WORK_LLAMADAS_ENTR_EMP_M3
          WHERE TIPO_LLAMADA = 'VOZ'
          GROUP BY MSISDN;
          
set mapred.job.name=WORK_ENTORNO_ENT_SMS_TOT_M3;
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_ENT_SMS_TOT_M3;
...
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_ENT_TOT;
...
set mapred.job.name=EMP_EXP_ENTORNO_LIN;
DROP TABLE IF EXISTS VF_EBU.EMP_EXP_ENTORNO_LIN;
CREATE TABLE VF_EBU.EMP_EXP_ENTORNO_LIN AS 
SELECT
M.CIF_NIF AS  NIF,
M.MSISDN,
ROUND(NUM_SAL_MIN_TOT,2) AS NUM_SAL_MIN_TOT     ,
ROUND(NUM_SAL_MIN_TOT_AVG,2) AS NUM_SAL_MIN_TOT_AVG          ,
ROUND(NUM_SAL_MIN_TOT_INC,2) AS NUM_SAL_MIN_TOT_INC          ,
ROUND(NUM_SAL_LLAM_DIST_TOT,2) AS NUM_SAL_LLAM_DIST_TOT      ,
ROUND(NUM_SAL_LLAM_DIST_TOT_AVG,2) AS NUM_SAL_LLAM_DIST_TOT_AVG           ,
ROUND(NUM_SAL_LLAM_DIST_TOT_INC,2) AS NUM_SAL_LLAM_DIST_TOT_INC           ,
ROUND(NUM_SAL_LLAM_TOT,2) AS NUM_SAL_LLAM_TOT   ,
ROUND(NUM_SAL_LLAM_TOT_AVG,2) AS NUM_SAL_LLAM_TOT_AVG        ,
ROUND(NUM_SAL_LLAM_TOT_INC,2) AS NUM_SAL_LLAM_TOT_INC        ,
ROUND(NUM_SAL_SMS_DIST_TOT,2) AS NUM_SAL_SMS_DIST_TOT        ,
ROUND(NUM_SAL_SMS_DIST_TOT_AVG,2) AS NUM_SAL_SMS_DIST_TOT_AVG,
ROUND(NUM_SAL_SMS_DIST_TOT_INC,2) AS NUM_SAL_SMS_DIST_TOT_INC,

ROUND(NUM_SAL_SMS_TOT,2) AS NUM_SAL_SMS_TOT     ,
ROUND(NUM_SAL_SMS_TOT_AVG,2) AS NUM_SAL_SMS_TOT_AVG          ,
ROUND(NUM_SAL_SMS_TOT_INC,2) AS NUM_SAL_SMS_TOT_INC          ,

ROUND(NUM_SAL_MIN_MV,2) AS NUM_SAL_MIN_MV       ,
ROUND(NUM_SAL_MIN_MV_AVG,2) AS NUM_SAL_MIN_MV_AVG            ,
ROUND(NUM_SAL_MIN_MV_INC,2) AS NUM_SAL_MIN_MV_INC            ,

ROUND(NUM_SAL_LLAM_DIST_MV,2) AS NUM_SAL_LLAM_DIST_MV        ,
ROUND(NUM_SAL_LLAM_DIST_MV_AVG,2) AS NUM_SAL_LLAM_DIST_MV_AVG,
ROUND(NUM_SAL_LLAM_DIST_MV_INC,2) AS NUM_SAL_LLAM_DIST_MV_INC,

ROUND(NUM_SAL_LLAM_MV,2) AS NUM_SAL_LLAM_MV     ,
ROUND(NUM_SAL_LLAM_MV_AVG,2) AS NUM_SAL_LLAM_MV_AVG          ,
ROUND(NUM_SAL_LLAM_MV_INC,2) AS NUM_SAL_LLAM_MV_INC          ,

ROUND(NUM_SAL_MIN_VF,2) AS NUM_SAL_MIN_VF       ,
ROUND(NUM_SAL_MIN_VF_AVG,2) AS NUM_SAL_MIN_VF_AVG            ,
ROUND(NUM_SAL_MIN_VF_INC,2) AS NUM_SAL_MIN_VF_INC            ,

ROUND(NUM_SAL_LLAM_DIST_VF,2) AS NUM_SAL_LLAM_DIST_VF        ,
ROUND(NUM_SAL_LLAM_DIST_VF_AVG,2) AS NUM_SAL_LLAM_DIST_VF_AVG,
ROUND(NUM_SAL_LLAM_DIST_VF_INC,2) AS NUM_SAL_LLAM_DIST_VF_INC,

ROUND(NUM_SAL_LLAM_VF,2) AS NUM_SAL_LLAM_VF     ,
ROUND(NUM_SAL_LLAM_VF_AVG,2) AS NUM_SAL_LLAM_VF_AVG          ,
ROUND(NUM_SAL_LLAM_VF_INC,2) AS NUM_SAL_LLAM_VF_INC          ,

ROUND(NUM_SAL_MIN_OG,2) AS NUM_SAL_MIN_OG       ,
ROUND(NUM_SAL_MIN_OG_AVG,2) AS NUM_SAL_MIN_OG_AVG            ,
ROUND(NUM_SAL_MIN_OG_INC,2) AS NUM_SAL_MIN_OG_INC            ,

ROUND(NUM_SAL_LLAM_DIST_OG,2) AS NUM_SAL_LLAM_DIST_OG        ,
ROUND(NUM_SAL_LLAM_DIST_OG_AVG,2) AS NUM_SAL_LLAM_DIST_OG_AVG,
ROUND(NUM_SAL_LLAM_DIST_OG_INC,2) AS NUM_SAL_LLAM_DIST_OG_INC,

ROUND(NUM_SAL_LLAM_OG,2) AS NUM_SAL_LLAM_OG     ,
ROUND(NUM_SAL_LLAM_OG_AVG,2) AS NUM_SAL_LLAM_OG_AVG          ,
ROUND(NUM_SAL_LLAM_OG_INC,2) AS NUM_SAL_LLAM_OG_INC          ,

ROUND(NUM_SAL_MIN_YO,2) AS NUM_SAL_MIN_YO       ,
ROUND(NUM_SAL_MIN_YO_AVG,2) AS NUM_SAL_MIN_YO_AVG            ,
ROUND(NUM_SAL_MIN_YO_INC,2) AS NUM_SAL_MIN_YO_INC            ,

ROUND(NUM_SAL_LLAM_DIST_YO,2) AS NUM_SAL_LLAM_DIST_YO        ,
ROUND(NUM_SAL_LLAM_DIST_YO_AVG,2) AS NUM_SAL_LLAM_DIST_YO_AVG,
ROUND(NUM_SAL_LLAM_DIST_YO_INC,2) AS NUM_SAL_LLAM_DIST_YO_INC,

ROUND(NUM_SAL_LLAM_YO,2) AS NUM_SAL_LLAM_YO     ,
ROUND(NUM_SAL_LLAM_YO_AVG,2) AS NUM_SAL_LLAM_YO_AVG          ,
ROUND(NUM_SAL_LLAM_YO_INC,2) AS NUM_SAL_LLAM_YO_INC          ,

ROUND(NUM_SAL_MIN_RE,2) AS NUM_SAL_MIN_RE       ,
ROUND(NUM_SAL_MIN_RE_AVG,2) AS NUM_SAL_MIN_RE_AVG            ,
ROUND(NUM_SAL_MIN_RE_INC,2) AS NUM_SAL_MIN_RE_INC            ,

ROUND(NUM_SAL_LLAM_DIST_RE,2) AS NUM_SAL_LLAM_DIST_RE        ,
ROUND(NUM_SAL_LLAM_DIST_RE_AVG,2) AS NUM_SAL_LLAM_DIST_RE_AVG,
ROUND(NUM_SAL_LLAM_DIST_RE_INC,2) AS NUM_SAL_LLAM_DIST_RE_INC,

ROUND(NUM_SAL_LLAM_RE,2) AS NUM_SAL_LLAM_RE     ,
ROUND(NUM_SAL_LLAM_RE_AVG,2) AS NUM_SAL_LLAM_RE_AVG          ,
ROUND(NUM_SAL_LLAM_RE_INC,2) AS NUM_SAL_LLAM_RE_INC          ,

ROUND(NUM_ENT_MIN_TOT,2) AS NUM_ENT_MIN_TOT     ,
ROUND(NUM_ENT_MIN_TOT_AVG,2) AS NUM_ENT_MIN_TOT_AVG          ,
ROUND(NUM_ENT_MIN_TOT_INC,2) AS NUM_ENT_MIN_TOT_INC          ,

ROUND(NUM_ENT_LLAM_DIST_TOT,2) AS NUM_ENT_LLAM_DIST_TOT      ,
ROUND(NUM_ENT_LLAM_DIST_TOT_AVG,2) AS NUM_ENT_LLAM_DIST_TOT_AVG           ,
ROUND(NUM_ENT_LLAM_DIST_TOT_INC,2) AS NUM_ENT_LLAM_DIST_TOT_INC           ,

ROUND(NUM_ENT_LLAM_TOT,2) AS NUM_ENT_LLAM_TOT   ,
ROUND(NUM_ENT_LLAM_TOT_AVG,2) AS NUM_ENT_LLAM_TOT_AVG        ,
ROUND(NUM_ENT_LLAM_TOT_INC,2) AS NUM_ENT_LLAM_TOT_INC        ,

ROUND(NUM_ENT_SMS_DIST_TOT,2) AS NUM_ENT_SMS_DIST_TOT        ,
ROUND(NUM_ENT_SMS_DIST_TOT_AVG,2) AS NUM_ENT_SMS_DIST_TOT_AVG,
ROUND(NUM_ENT_SMS_DIST_TOT_INC,2) AS NUM_ENT_SMS_DIST_TOT_INC,

ROUND(NUM_ENT_SMS_TOT,2) AS NUM_ENT_SMS_TOT     ,
ROUND(NUM_ENT_SMS_TOT_AVG,2) AS NUM_ENT_SMS_TOT_AVG          ,
ROUND(NUM_ENT_SMS_TOT_INC,2) AS NUM_ENT_SMS_TOT_INC          ,

ROUND(NUM_SAL_MIN_TOT_M1,2) AS NUM_SAL_MIN_TOT_M1            ,
ROUND(NUM_SAL_MIN_TOT_M2,2) AS NUM_SAL_MIN_TOT_M2            ,
ROUND(NUM_SAL_MIN_TOT_M3,2) AS NUM_SAL_MIN_TOT_M3            ,

ROUND(NUM_SAL_LLAM_DIST_TOT_M1,2) AS NUM_SAL_LLAM_DIST_TOT_M1,
ROUND(NUM_SAL_LLAM_DIST_TOT_M2,2) AS NUM_SAL_LLAM_DIST_TOT_M2,
ROUND(NUM_SAL_LLAM_DIST_TOT_M3,2) AS NUM_SAL_LLAM_DIST_TOT_M3,

ROUND(NUM_SAL_LLAM_TOT_M1,2) AS NUM_SAL_LLAM_TOT_M1          ,
ROUND(NUM_SAL_LLAM_TOT_M2,2) AS NUM_SAL_LLAM_TOT_M2          ,
ROUND(NUM_SAL_LLAM_TOT_M3,2) AS NUM_SAL_LLAM_TOT_M3          ,

ROUND(NUM_SAL_SMS_DIST_TOT_M1,2) AS NUM_SAL_SMS_DIST_TOT_M1  ,
ROUND(NUM_SAL_SMS_DIST_TOT_M2,2) AS NUM_SAL_SMS_DIST_TOT_M2  ,
ROUND(NUM_SAL_SMS_DIST_TOT_M3,2) AS NUM_SAL_SMS_DIST_TOT_M3  ,

ROUND(NUM_SAL_SMS_TOT_M1,2) AS NUM_SAL_SMS_TOT_M1            ,
ROUND(NUM_SAL_SMS_TOT_M2,2) AS NUM_SAL_SMS_TOT_M2            ,
ROUND(NUM_SAL_SMS_TOT_M3,2) AS NUM_SAL_SMS_TOT_M3            ,

ROUND(NUM_SAL_MIN_MV_M1,2) AS NUM_SAL_MIN_MV_M1 ,
ROUND(NUM_SAL_MIN_MV_M2,2) AS NUM_SAL_MIN_MV_M2 ,
ROUND(NUM_SAL_MIN_MV_M3,2) AS NUM_SAL_MIN_MV_M3 ,

ROUND(NUM_SAL_LLAM_DIST_MV_M1,2) AS NUM_SAL_LLAM_DIST_MV_M1  ,
ROUND(NUM_SAL_LLAM_DIST_MV_M2,2) AS NUM_SAL_LLAM_DIST_MV_M2  ,
ROUND(NUM_SAL_LLAM_DIST_MV_M3,2) AS NUM_SAL_LLAM_DIST_MV_M3  ,

ROUND(NUM_SAL_LLAM_MV_M1,2) AS NUM_SAL_LLAM_MV_M1            ,
ROUND(NUM_SAL_LLAM_MV_M2,2) AS NUM_SAL_LLAM_MV_M2            ,
ROUND(NUM_SAL_LLAM_MV_M3,2) AS NUM_SAL_LLAM_MV_M3            ,

ROUND(NUM_SAL_MIN_VF_M1,2) AS NUM_SAL_MIN_VF_M1 ,
ROUND(NUM_SAL_MIN_VF_M2,2) AS NUM_SAL_MIN_VF_M2 ,
ROUND(NUM_SAL_MIN_VF_M3,2) AS NUM_SAL_MIN_VF_M3 ,

ROUND(NUM_SAL_LLAM_DIST_VF_M1,2) AS NUM_SAL_LLAM_DIST_VF_M1  ,
ROUND(NUM_SAL_LLAM_DIST_VF_M2,2) AS NUM_SAL_LLAM_DIST_VF_M2  ,
ROUND(NUM_SAL_LLAM_DIST_VF_M3,2) AS NUM_SAL_LLAM_DIST_VF_M3  ,

ROUND(NUM_SAL_LLAM_VF_M1,2) AS NUM_SAL_LLAM_VF_M1            ,
ROUND(NUM_SAL_LLAM_VF_M2,2) AS NUM_SAL_LLAM_VF_M2            ,
ROUND(NUM_SAL_LLAM_VF_M3,2) AS NUM_SAL_LLAM_VF_M3            ,

ROUND(NUM_SAL_MIN_OG_M1,2) AS NUM_SAL_MIN_OG_M1 ,
ROUND(NUM_SAL_MIN_OG_M2,2) AS NUM_SAL_MIN_OG_M2 ,
ROUND(NUM_SAL_MIN_OG_M3,2) AS NUM_SAL_MIN_OG_M3 ,

ROUND(NUM_SAL_LLAM_DIST_OG_M1,2) AS NUM_SAL_LLAM_DIST_OG_M1  ,
ROUND(NUM_SAL_LLAM_DIST_OG_M2,2) AS NUM_SAL_LLAM_DIST_OG_M2  ,
ROUND(NUM_SAL_LLAM_DIST_OG_M3,2) AS NUM_SAL_LLAM_DIST_OG_M3  ,

ROUND(NUM_SAL_LLAM_OG_M1,2) AS NUM_SAL_LLAM_OG_M1            ,
ROUND(NUM_SAL_LLAM_OG_M2,2) AS NUM_SAL_LLAM_OG_M2            ,
ROUND(NUM_SAL_LLAM_OG_M3,2) AS NUM_SAL_LLAM_OG_M3            ,

ROUND(NUM_SAL_MIN_YO_M1,2) AS NUM_SAL_MIN_YO_M1 ,
ROUND(NUM_SAL_MIN_YO_M2,2) AS NUM_SAL_MIN_YO_M2 ,
ROUND(NUM_SAL_MIN_YO_M3,2) AS NUM_SAL_MIN_YO_M3 ,

ROUND(NUM_SAL_LLAM_DIST_YO_M1,2) AS NUM_SAL_LLAM_DIST_YO_M1  ,
ROUND(NUM_SAL_LLAM_DIST_YO_M2,2) AS NUM_SAL_LLAM_DIST_YO_M2  ,
ROUND(NUM_SAL_LLAM_DIST_YO_M3,2) AS NUM_SAL_LLAM_DIST_YO_M3  ,

ROUND(NUM_SAL_LLAM_YO_M1,2) AS NUM_SAL_LLAM_YO_M1            ,
ROUND(NUM_SAL_LLAM_YO_M2,2) AS NUM_SAL_LLAM_YO_M2            ,
ROUND(NUM_SAL_LLAM_YO_M3,2) AS NUM_SAL_LLAM_YO_M3            ,

ROUND(NUM_SAL_MIN_RE_M1,2) AS NUM_SAL_MIN_RE_M1 ,
ROUND(NUM_SAL_MIN_RE_M2,2) AS NUM_SAL_MIN_RE_M2 ,
ROUND(NUM_SAL_MIN_RE_M3,2) AS NUM_SAL_MIN_RE_M3 ,

ROUND(NUM_SAL_LLAM_DIST_RE_M1,2) AS NUM_SAL_LLAM_DIST_RE_M1  ,
ROUND(NUM_SAL_LLAM_DIST_RE_M2,2) AS NUM_SAL_LLAM_DIST_RE_M2  ,
ROUND(NUM_SAL_LLAM_DIST_RE_M3,2) AS NUM_SAL_LLAM_DIST_RE_M3  ,

ROUND(NUM_SAL_LLAM_RE_M1,2) AS NUM_SAL_LLAM_RE_M1            ,
ROUND(NUM_SAL_LLAM_RE_M2,2) AS NUM_SAL_LLAM_RE_M2            ,
ROUND(NUM_SAL_LLAM_RE_M3,2) AS NUM_SAL_LLAM_RE_M3            ,

ROUND(NUM_ENT_MIN_TOT_M1,2) AS NUM_ENT_MIN_TOT_M1            ,
ROUND(NUM_ENT_MIN_TOT_M2,2) AS NUM_ENT_MIN_TOT_M2            ,
ROUND(NUM_ENT_MIN_TOT_M3,2) AS NUM_ENT_MIN_TOT_M3            ,

ROUND(NUM_ENT_LLAM_DIST_TOT_M1,2) AS NUM_ENT_LLAM_DIST_TOT_M1,
ROUND(NUM_ENT_LLAM_DIST_TOT_M2,2) AS NUM_ENT_LLAM_DIST_TOT_M2,
ROUND(NUM_ENT_LLAM_DIST_TOT_M3,2) AS NUM_ENT_LLAM_DIST_TOT_M3,

ROUND(NUM_ENT_LLAM_TOT_M1,2) AS NUM_ENT_LLAM_TOT_M1          ,
ROUND(NUM_ENT_LLAM_TOT_M2,2) AS NUM_ENT_LLAM_TOT_M2          ,
ROUND(NUM_ENT_LLAM_TOT_M3,2) AS NUM_ENT_LLAM_TOT_M3          ,

ROUND(NUM_ENT_SMS_DIST_TOT_M1,2) AS NUM_ENT_SMS_DIST_TOT_M1  ,
ROUND(NUM_ENT_SMS_DIST_TOT_M2,2) AS NUM_ENT_SMS_DIST_TOT_M2  ,
ROUND(NUM_ENT_SMS_DIST_TOT_M3,2) AS NUM_ENT_SMS_DIST_TOT_M3  ,

ROUND(NUM_ENT_SMS_TOT_M1,2) AS NUM_ENT_SMS_TOT_M1            ,
ROUND(NUM_ENT_SMS_TOT_M2,2) AS NUM_ENT_SMS_TOT_M2            ,
ROUND(NUM_ENT_SMS_TOT_M3,2) AS NUM_ENT_SMS_TOT_M3
FROM
...
DROP TABLE IF EXISTS WORK.WORK_ENTORNO_CLI;
CREATE TABLE WORK.WORK_ENTORNO_CLI AS
      ...
      FROM
          VF_EBU.EMP_EXP_ENTORNO_LIN
      GROUP BY NIF;

set mapred.job.name=EMP_EXP_ENTORNO_CLI;
DROP TABLE IF EXISTS VF_EBU.EMP_EXP_ENTORNO_CLI;
CREATE TABLE VF_EBU.EMP_EXP_ENTORNO_CLI AS
        SELECT
            NIF,
...
DROP TABLE WORK.WORK_LLAMADAS_SAL_EMP; 
DROP TABLE WORK.WORK_LLAMADAS_ENTR_EMP_M0; 
DROP TABLE WORK.WORK_LLAMADAS_ENTR_EMP_M1;  
DROP TABLE WORK.WORK_LLAMADAS_ENTR_EMP_M2; 
DROP TABLE WORK.WORK_LLAMADAS_ENTR_EMP_M3;
