  ...
  def main(args: Array[String]): Unit = {
    ...
    val featCols = balDtTr
      ...
      .diff(Metadata.getIdFeats()
        ...
        .union(Metadata.getProcessedBillingColumns())
    ...
    println("\n[Info AmdocsChurnModel Predictor] After computing the preds on the test set - Number of samples scored: " + ttPredictions.count() + "\n")
    ...
    println("\n[Info AmdocsChurnModel Predictor] Output table prepared - Number of records: " + tmpdf.count() + "\n")
    ...
    tmpdf.show
      ...
      tmpdf
        ...
        .format("parquet")
        .mode("append")
        .insertInto("tests_es.jvmm_amdocs_churn_scores")
