...
SOURCES="navcomp,customer,spinners,myvf_v2"
...
LOGGING_FILE=/var/SP/data/bdpmdses/deliveries_churn/logs_triggers/myvf_production_${PLATFORM}_${TR_DATE}_${TT_DATE}_`date '+%Y%m%d_%H%M%S'`.log
