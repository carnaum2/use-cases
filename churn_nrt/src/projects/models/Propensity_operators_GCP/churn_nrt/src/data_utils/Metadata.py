...
from my_propensity_operators.churn_nrt.src.utils.pyspark_utils import impute_with_mean
...
class Metadata:
    ...
    def get_metadata_df(self, sources=None):
        '''
        ...
        df_metadata = self.METADATA_FUNCTION(self.SPARK, sources=sources)

        return df_metadata

    def get_cols(self, type_=None, sources=None):
        '''
    ...
    def get_metadata_function_abspath(self):
        return self.METADATA_FUNCTION.__code__.co_filename
