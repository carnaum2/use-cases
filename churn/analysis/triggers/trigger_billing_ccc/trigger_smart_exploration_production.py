...
CAR_PATH = "/data/udf/vf_es/churn/triggers/car_exploration_model1/"
CAR_PATH_UNLABELED = "/data/udf/vf_es/churn/triggers/car_exploration_unlabeled_model1/"
...
def get_customer_master(spark, closing_day):
    ...
    tr_base = (get_customer_master(spark, closing_day, unlabeled=False)
               ...
               .select('nif_cliente', 'blindaje', 'nb_rgus', 'nb_tv_services_nif', 'segment_nif', 'label'))
...
if __name__ == "__main__":
    ...
    path_to_save = "/data/udf/vf_es/churn/triggers/model1_50k_filt/"
    start_time = time.time()
