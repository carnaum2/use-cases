...
if __name__ == "__main__":
    ...
    path = '/data/udf/vf_es/churn/triggers/feat_imp_filtered/year={}/month={}/day={}'.format(int(starting_day[:4]),
                                                                                    int(starting_day[4:6]),
                                                                                    int(starting_day[6:8]))
    ...
    n_save = 50000
    path = '/data/udf/vf_es/churn/triggers/model2_50k_filtered/year={}/month={}/day={}'.format(int(closing_day[:4]),
                                                                                      int(closing_day[4:6]),
                                                                                      int(closing_day[6:8]))
