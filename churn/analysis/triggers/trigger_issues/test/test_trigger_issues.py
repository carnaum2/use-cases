...
from ccc_utils import *

def get_service_last_date(spark):

  last_date = spark\
  .read\
  .parquet('/data/raw/vf_es/customerprofilecar/SERVICESOW/1.0/parquet/')\
...
def get_services(spark, date_):
    ...
    PATH_RAW_SERVICE = path_raw_base + 'customerprofilecar/SERVICESOW/1.0/parquet/'
...
def get_customer_base(spark, date_):
    ...
    .select('NUM_CLIENTE', 'NIF_CLIENTE', 'msisdn', 'rgu')\
