...
#copied to churn_nrt ... spinners.py
def get_spinners_attributes_nif(spark, date_):
    ...
    sopodf = spark\
        ...
        .withColumn("ref_date", from_unixtime(unix_timestamp(lit(date_), "yyyyMMdd")))\
    ...
    #nifsopodf.write.format("parquet").mode("overwrite").saveAsTable("tests_es.jvmm_amdocs_car_mobile_sopo_" + process_date + "_tmp")
