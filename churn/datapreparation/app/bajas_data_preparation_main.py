...
def set_paths_and_logger():
    ...
    import os
    USE_CASES = dirname(dirname(os.path.abspath(imp.find_module('datapreparation')[1])))
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Track de bajas. Run with: spark2-submit $SPARK_COMMON_OPTS --conf spark.port.maxRetries=50 --conf spark.driver.memory=16g --conf spark.executor.memory=16g data_preparation_main.py --starting-day <StartingDay> --closing-day <ClosingDay> --personal-usage <flag_personal_usage>',
    ...
    config_obj = TrackBajasConfig(args.inputfile)

    # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    # GET UNLABELED/LABELED CAR
    # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    from churn.datapreparation.engine.bajas_data_loader import get_labeled_or_unlabeled_car
